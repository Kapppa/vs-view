...
- [Usage](usage/overview.md): CLI usage, file detection, workspaces, and shortcuts.
- [Plugins](plugins/overview.md): Built-in tools, official plugins, and plugin development.
