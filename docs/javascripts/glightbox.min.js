          ...
          value: function (e) {
            if (this.slide.classList.contains("zoomed")) this.active = !1;
              ...
              -1 !== ["input", "select", "textarea", "button", "a"].indexOf(t)
                ? (this.active = !1)
                : (e.preventDefault(),
                  (e.target === this.el || ("img" !== t && g(e.target, ".gslide-inline"))) &&
                    ((this.active = !0),
  ...
  function _(e, t, i, n) {
    ...
    ((r.style.maxWidth = t.width),
      w(this.settings.plyr.js, "Plyr", function () {
        ...
        var r =
          g ||
          y('<div id="'.concat(o, '" data-plyr-provider="').concat(u, '" data-plyr-embed-id="').concat(c, '"></div>'));
          ...
          value: function () {
            ...
            if (
              (C(n.afterSlideLoad) &&
                (v = function () {
                  (C(i) && i(),
                    n.afterSlideLoad({ index: e.index, slide: t, player: e.instance.getSlidePlayerInstance(e.index) }));
                }),
        ...
        value: function (e) {
          if (e.touches) {
            ...
            if (((this.isDoubleTap = !1), i > 1)) {
              ...
              (null !== t.x &&
                (this.pinchStartLen > 0 && ((e.zoom = F(r) / this.pinchStartLen), this.pinch.dispatch(e, this.element)),
                (e.angle = R(r, t)),
        ...
        },
        {
          ...
          value: function () {
            ...
            if (E(e)) {
              ...
              (n &&
                ((this.fullElementsList = this.elements), (this.elements = this.getGalleryElements(this.elements, n))),
          ...
          value: function () {
            ...
            ((this.slideDescription = s.querySelector(".gslide-description")),
              (this.slideDescriptionContained =
                this.slideDescription && u(this.slideDescription.parentNode, "gslide-media")),
